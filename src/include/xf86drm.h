...
#else  //SylixOS
#define DRM_SYX_GPU_NAME        "/dev/gpu"  //SYlixOS下FB的操作。可以ioctl 此文件进行操作gb驱动
#define DRM_DIR_NAME  		        DRM_SYX_GPU_NAME
#define DRM_PRIMARY_MINOR_NAME      DRM_SYX_GPU_NAME
#define DRM_CONTROL_MINOR_NAME      DRM_SYX_GPU_NAME
#define DRM_RENDER_MINOR_NAME       DRM_SYX_GPU_NAME
#define DRM_PROC_NAME 		        DRM_SYX_GPU_NAME
#define DRM_DEV_NAME                DRM_SYX_GPU_NAME
#define DRM_CONTROL_DEV_NAME        DRM_SYX_GPU_NAME
#define DRM_RENDER_DEV_NAME         DRM_SYX_GPU_NAME
#endif
...
// #define drmMsg(fmt, ...)        _PrintFormat(fmt, ...)
